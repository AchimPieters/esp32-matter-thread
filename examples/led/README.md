...
- `espressif/esp_encrypted_img == 2.1.0` via lokale compat-override (`examples/led/components/esp_encrypted_img_compat`) voor IDF 5.4 toolchain/layout
- lokale `components/json` shim (REQUIRES `cjson`) + `espressif/mqtt` voor ESP-IDF 6.0 compatibiliteit
