...
- **Primair ondersteund:** ESP-IDF `5.4.x` (CI bouwt met `espressif/idf:v5.4.2`, `esp_matter==1.4.0` en een LED-project lokale compat-override voor `esp_encrypted_img@2.1.0`).
